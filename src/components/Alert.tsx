...
const Alert = ({
  ...
  switch (data.type) {
    case "SUCCESS":
      return (
        <div className="fixed bottom-12 right-4 z-[1000] w-96 rounded-md bg-green-50 p-4 shadow transition-all md:right-12">
          <div className="flex">
    ...
    case "ERROR":
      return (
        <div className="fixed bottom-12 z-[1000] right-4 w-96 rounded-md bg-red-50 p-4 shadow transition-all md:right-12">
          <div className="flex">
            <div className="flex-shrink-0">
              <IoMdCloseCircle
    ...
    case "WARNING":
      return (
        <div className="fixed bottom-12 z-[1000] right-4 w-96 rounded-md bg-yellow-50 p-4 shadow transition-all md:right-12">
          <div className="flex">
            <div className="flex-shrink-0">
              <IoMdWarning
    ...
    case "INFO":
      return (
        <div className="fixed bottom-12 z-[1000] right-4 w-96 rounded-md bg-blue-50 p-4 shadow transition-all md:right-12">
          <div className="flex">
            <div className="flex-shrink-0">
